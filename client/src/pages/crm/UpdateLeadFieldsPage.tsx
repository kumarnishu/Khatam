import { GetLeadFieldsUpdatable, UpdateLeadFieldsUpdatable } from '../../services/CrmServices'
...
const template = {
    ...
    stages: ["open", "closed", "potential", "useless"],
}
        ...
        <>
            ...
            {user?.crm_access_fields.is_editable &&
                <Button size="large" sx={{ position: 'absolute', right: 20, m: 1 }} variant='outlined' color="primary" onClick={() => {
                    ...
                    disabled={!user?.crm_access_fields.is_deletion_allowed}
                >
                    Save
                </Button>}
