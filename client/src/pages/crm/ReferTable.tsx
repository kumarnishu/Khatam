...
import { STable, STableBody, STableCell, STableHead, STableHeadCell, STableRow } from "./../../components/styled/Table"
...
import UpdateReferDialog from '../../components/dialogs/crm/UpdateReferDialog'
import DeleteReferDialog from '../../components/dialogs/crm/DeleteReferDialog'
import AssignReferDialog from '../../components/dialogs/crm/AssignReferDialog'
import ViewReferralsDialog from '../../components/dialogs/crm/ViewReferralsDialog'
...
function ReferTable({ refer, selectAll, refers, setSelectAll, setRefer, selectedRefers, setSelectedRefers }: Props) {
                                                                ...
                                                                <>
                                                                    <Tooltip title="edit">
                                                                        <IconButton
                                                                            onClick={() => {
                                                                                setRefer(refer.party)
                                                                                setChoice({ type: CrmChoiceActions.update_refer })
                                                            ...
                                                            {user?.crm_access_fields.is_editable &&
                                                                < Tooltip title="Assign Refer">
                                                                    <IconButton color="warning"
                                                                        onClick={() => {
                                                                            setRefer(refer.party)
                                                                            setChoice({ type: CrmChoiceActions.assign_refer })
                                                                        }}
                                                                    >
                                                                        <Handshake />
                                                                    </IconButton>
