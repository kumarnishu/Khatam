...
import { FuzzySearchRefers, GetPaginatedRefers } from '../../services/CrmServices'
            ...
            >
                ...
                >
                    ...
                    <>
                        ...
                        >
                            <MenuItem onClick={() => {
                                setChoice({ type: CrmChoiceActions.create_refer })
                                setAnchorEl(null)
                            }}
                            >New Refer</MenuItem>
                                ...
                                <MenuItem
                                    onClick={() => {
                                        if (selectedRefers.length === 0)
                                            ...
                                            setChoice({ type: CrmChoiceActions.bulk_assign_refers })
                                        setAnchorEl(null)
                                    }}
