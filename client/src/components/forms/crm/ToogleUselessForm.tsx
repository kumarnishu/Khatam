...
import { ToogleUseless } from '../../../services/CrmServices';
import AlertBar from '../../snacks/AlertBar';
import { ILead, IReferredParty } from '../../../types/crm.types';



function ToogleUselessForm({ lead }: { lead: ILead }) {
    ...
    return (
        <form onSubmit={formik.handleSubmit}>
            ...
            >
                ...
                {
                    isSuccess ? (
                        <AlertBar message="successfully changed status" color="success" />
                    ) : null
                }
...
export default ToogleUselessForm
